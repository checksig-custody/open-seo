...
/**
 * Morgana Search Intelligence — phase 5: Site Audit and AI Visibility.
 *
 ...
 * batches it takes.
 */
export const siSiteAuditRuns = sqliteTable(
  "si_site_audit_runs",
  {
 ...
 */
export const siSiteAuditFrontier = sqliteTable(
...
export const siSiteAuditPages = sqliteTable(
  "si_site_audit_pages",
  {
    id: text("id").primaryKey(),
    runId: text("run_id").notNull(),
...
export const siSiteAuditLinks = sqliteTable(
  "si_site_audit_links",
  {
    id: text("id").primaryKey(),
    runId: text("run_id").notNull(),
 ...
 */
export const siSiteAuditIssues = sqliteTable(
...
export const siSiteAuditIssueEvents = sqliteTable(
 ...
 */
export const siSiteAuditUsageLedger = sqliteTable(
