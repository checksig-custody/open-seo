...
/**
 * Morgana Search Intelligence — phase 5 AI Visibility schema.
 *
 ...
 */
export const siAiVisibilityQueries = sqliteTable(
 ...
 */
export const siAiVisibilitySnapshots = sqliteTable(
  "si_ai_visibility_snapshots",
  {
    ...
    aiResultPresent: integer("ai_result_present", { mode: "boolean" }),
    primaryBrandMentioned: integer("primary_brand_mentioned", {
      mode: "boolean",
    }),
    primaryBrandCited: integer("primary_brand_cited", { mode: "boolean" }),
...
export const siAiVisibilityCitations = sqliteTable(
...
export const siAiVisibilityEvents = sqliteTable(
